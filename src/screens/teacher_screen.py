...
def teacher_screen_login():
    ...
    teacher_username=st.text_input("Enter username",placeholder='sweety')
...
def teacher_screen_register():
    ...
    teacher_username=st.text_input("Enter username",placeholder='sweety')
    teacher_name=st.text_input("Enter name",placeholder='Anushka')
    teacher_pass=st.text_input("Enter password",type='password',placeholder="Enter password")
    teacher_pass_confirm=st.text_input("Cnfirm password",type='password',placeholder='Re-enter password')
